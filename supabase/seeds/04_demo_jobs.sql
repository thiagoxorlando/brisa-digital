-- ============================================================
-- DEMO JOBS — 32 jobs  (run fourth)
--
-- Job UUIDs: c0000003-0000-4000-8000-0000000000{01..32}
--   Wave Creative   01-08   Blue Horizon 09-16
--   Prime Talent    17-24   Lighthouse   25-28
--   Urban Vision    29-32
-- ============================================================
...
VALUES
  -- ── WAVE CREATIVE (a0000001-...-001) ─────────────────────
  ('c0000003-0000-4000-8000-000000000001','a0000001-0000-4000-8000-000000000001',
  ...
  ('c0000003-0000-4000-8000-000000000002','a0000001-0000-4000-8000-000000000001',
  ...
  ('c0000003-0000-4000-8000-000000000005','a0000001-0000-4000-8000-000000000001',
  ...
  ('c0000003-0000-4000-8000-000000000006','a0000001-0000-4000-8000-000000000001',
  ...
  ('c0000003-0000-4000-8000-000000000007','a0000001-0000-4000-8000-000000000001',
  ...
  ('c0000003-0000-4000-8000-000000000008','a0000001-0000-4000-8000-000000000001',
  ...
  -- ── BLUE HORIZON (a0000001-...-002) ──────────────────────
  ('c0000003-0000-4000-8000-000000000009','a0000001-0000-4000-8000-000000000002',
  ...
  ('c0000003-0000-4000-8000-000000000012','a0000001-0000-4000-8000-000000000002',
  ...
  ('c0000003-0000-4000-8000-000000000013','a0000001-0000-4000-8000-000000000002',
  ...
  ('c0000003-0000-4000-8000-000000000014','a0000001-0000-4000-8000-000000000002',
  ...
  ('c0000003-0000-4000-8000-000000000015','a0000001-0000-4000-8000-000000000002',
  ...
  ('c0000003-0000-4000-8000-000000000016','a0000001-0000-4000-8000-000000000002',
  ...
  ('c0000003-0000-4000-8000-000000000019','a0000001-0000-4000-8000-000000000003',
  ...
  ('c0000003-0000-4000-8000-000000000020','a0000001-0000-4000-8000-000000000003',
  ...
  ('c0000003-0000-4000-8000-000000000021','a0000001-0000-4000-8000-000000000003',
  ...
  ('c0000003-0000-4000-8000-000000000022','a0000001-0000-4000-8000-000000000003',
  ...
  ('c0000003-0000-4000-8000-000000000023','a0000001-0000-4000-8000-000000000003',
   'Fotografia de Produto — Linha Infantil',
   'Fotógrafo(a) para linha de roupas infantis. Fundo branco e externas.',
   'Photographer',2000.00,'2026-07-01','2026-07-05','São Paulo, SP','open',1,
   now()-interval'1 day',NULL),

  ('c0000003-0000-4000-8000-000000000024','a0000001-0000-4000-8000-000000000003',
  ...
  -- ── LIGHTHOUSE MEDIA (a0000001-...-004) ──────────────────
  ('c0000003-0000-4000-8000-000000000025','a0000001-0000-4000-8000-000000000004',
   'Cobertura Fotográfica — Evento Corporativo',
  ...
  ('c0000003-0000-4000-8000-000000000026','a0000001-0000-4000-8000-000000000004',
  ...
  ('c0000003-0000-4000-8000-000000000027','a0000001-0000-4000-8000-000000000004',
  ...
  ('c0000003-0000-4000-8000-000000000028','a0000001-0000-4000-8000-000000000004',
  ...
  -- ── URBAN VISION STUDIOS (a0000001-...-005) ──────────────
  ...
  ('c0000003-0000-4000-8000-000000000031','a0000001-0000-4000-8000-000000000005',
  ...
  ('c0000003-0000-4000-8000-000000000032','a0000001-0000-4000-8000-000000000005',
