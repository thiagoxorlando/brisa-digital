...
export default async function AdminContractsPage() {
  ...
  const { data: rows } = await supabase
    .from("contracts")
    .select("id, job_id, agency_id, talent_id, job_date, job_time, location, job_description, payment_amount, payment_method, additional_notes, status, created_at, signed_at, agency_signed_at, deposit_paid_at, paid_at")
    .is("deleted_at", null)
