...
export default async function WorkspaceTalentDisputesPage({ params }: Props) {
  ...
  return (
    <div className="max-w-5xl space-y-6 px-4 pb-10 sm:px-6">
      <div>
        <h1 className="text-[1.75rem] font-semibold tracking-tight text-zinc-950">Disputas</h1>
        <p className="mt-1 text-[14px] text-zinc-500">
          Contratos em processo de disputa no workspace {workspace.name}.
        </p>
      </div>
                ...
                return (
                  <tr key={dispute.id} className="transition-colors hover:bg-zinc-50/60">
                    ...
                    <td className="px-4 py-4 text-right">
                      <Link
                        href={`/talent/workspaces/${workspaceSlug}/disputes/${dispute.id}`}
