...
export default async function TalentDisputeDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="max-w-4xl space-y-6 px-4 pb-10 sm:px-6">
      <div>
        <Link href="/talent/disputes" className="text-[12px] font-semibold text-teal-700 hover:text-teal-800">
