...
export default function FrozenBanner() {
  ...
  return (
    <div className="flex items-center justify-between gap-4 bg-rose-50 border border-rose-100 rounded-2xl px-5 py-3.5 mb-6">
      ...
      <Link
        href="/agency/billing"
        className="flex-shrink-0 text-[12px] font-semibold text-white bg-rose-500 hover:bg-rose-600 px-4 py-2 rounded-xl transition-colors whitespace-nowrap"
      >
        {isPT ? "Reativar PRO" : "Reactivate PRO"}
      </Link>
    </div>
  );
}
