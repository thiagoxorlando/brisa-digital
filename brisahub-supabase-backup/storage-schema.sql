...
CREATE POLICY "contracts_bucket_authenticated_insert_original" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'contracts'::"text") AND ((("array_length"("storage"."foldername"("name"), 1) >= 3) AND (("storage"."foldername"("name"))[1] = 'contracts'::"text") AND (("storage"."foldername"("name"))[2] = ("auth"."uid"())::"text") AND (EXISTS ( SELECT 1
   FROM "public"."jobs" "j"
  WHERE ((("j"."id")::"text" = ("storage"."foldername"("objects"."name"))[3]) AND ("j"."agency_id" = "auth"."uid"()) AND ("j"."workspace_id" IS NULL))))) OR (("array_length"("storage"."foldername"("name"), 1) >= 7) AND (("storage"."foldername"("name"))[1] = 'contracts'::"text") AND (("storage"."foldername"("name"))[2] = 'open'::"text") AND (("storage"."foldername"("name"))[3] = ("auth"."uid"())::"text") AND (("storage"."foldername"("name"))[4] = 'jobs'::"text") AND (("storage"."foldername"("name"))[6] = 'agency'::"text") AND (("storage"."foldername"("name"))[7] = ("auth"."uid"())::"text") AND (EXISTS ( SELECT 1
   FROM "public"."jobs" "j"
  WHERE ((("j"."id")::"text" = ("storage"."foldername"("objects"."name"))[5]) AND ("j"."agency_id" = "auth"."uid"()) AND ("j"."workspace_id" IS NULL))))) OR (("array_length"("storage"."foldername"("name"), 1) >= 7) AND (("storage"."foldername"("name"))[1] = 'contracts'::"text") AND (("storage"."foldername"("name"))[2] = 'workspaces'::"text") AND (("storage"."foldername"("name"))[4] = 'jobs'::"text") AND (("storage"."foldername"("name"))[6] = 'agency'::"text") AND (("storage"."foldername"("name"))[7] = ("auth"."uid"())::"text") AND (EXISTS ( SELECT 1
   FROM ("public"."jobs" "j"
     JOIN "public"."premium_workspace_members" "pwm" ON ((("pwm"."workspace_id" = "j"."workspace_id") AND ("pwm"."user_id" = "auth"."uid"()) AND ("pwm"."status" = 'active'::"text"))))
  WHERE ((("j"."id")::"text" = ("storage"."foldername"("objects"."name"))[5]) AND (("j"."workspace_id")::"text" = ("storage"."foldername"("objects"."name"))[3]) AND (("pwm"."role" = 'owner'::"text") OR ("j"."created_by_user_id" = "auth"."uid"())))))))));



CREATE POLICY "contracts_bucket_authenticated_insert_signed" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'contracts'::"text") AND ("array_length"("storage"."foldername"("name"), 1) >= 4) AND (("storage"."foldername"("name"))[1] = 'contracts'::"text") AND (("storage"."foldername"("name"))[2] = 'signed'::"text") AND (("storage"."foldername"("name"))[3] = ("auth"."uid"())::"text") AND (EXISTS ( SELECT 1
   FROM "public"."contracts" "c"
  WHERE ((("c"."id")::"text" = ("storage"."foldername"("objects"."name"))[4]) AND ("c"."talent_user_id" = "auth"."uid"()))))));
